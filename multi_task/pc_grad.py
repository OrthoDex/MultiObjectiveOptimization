...
### Note from Ishaan:
### Todo:
### 1. Remove memoize, can't hold dimensions in memory for large networks, use parameters
### Update: done, save and restore dims in inner map loop
### 2. Test on chexpert model pickle file
### Works: not better results
### 3. Validate on https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html
### 4. Optimize runtime and memory further
